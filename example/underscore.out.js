function underscore(fname, args) {
  ...
  var hasEnumBug = (__cov__.stmt.add(17), !({
    toString: null
  }).propertyIsEnumerable('toString'));
  var nonEnumerableProps = (__cov__.stmt.add(18), ['valueOf', 'isPrototypeOf', 'toString', 'propertyIsEnumerable', 'hasOwnProperty', 'toLocaleString']);
  ...
  var forEachName = (__cov__.stmt.add(239), 'forEach'), hasName = (__cov__.stmt.add(240), 'has'), commonInit = (__cov__.stmt.add(241), ['clear', 'delete']), mapTail = (__cov__.stmt.add(242), ['get', hasName, 'set']);
  ...
  function template(text, settings, oldSettings) {
    ...
    var matcher = (__cov__.stmt.add(412), RegExp([((__cov__.branch.add(275), settings.escape) || (__cov__.branch.add(276), noMatch)).source, ((__cov__.branch.add(277), settings.interpolate) || (__cov__.branch.add(278), noMatch)).source, ((__cov__.branch.add(279), settings.evaluate) || (__cov__.branch.add(280), noMatch)).source].join('|') + '|$', 'g'));
  ...
  function group(behavior, partition) {
    ...
    return function (obj, iteratee, context) {
      ...
      var result = (__cov__.stmt.add(809), partition ? (__cov__.branch.add(529), [[], []]) : (__cov__.branch.add(530), {}));
